...
public class WatcherFacade {
    ...
    @AfterThrowing("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processorOrder(..))" +
            "&& args(orderDto, userId) && target(object)")
    ...
    @After("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processorOrder(..))" +
            "&& args(orderDto, userId) && target(object)")
