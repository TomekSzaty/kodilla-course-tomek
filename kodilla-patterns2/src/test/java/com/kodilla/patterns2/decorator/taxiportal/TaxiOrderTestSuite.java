...
public class TaxiOrderTestSuite {
    ...
    void testMyTaxiWithChildSeatGetDescription() {
        ...
        //Then
        assertEquals("Drive a course by MyTaxiNetwork plus child seat", description);
    ...
    void testUberWithTwoChildSeatGetDescription() {
        ...
        String description = taxiOrder.getDescription();
        //Then
        assertEquals("Drive a course by UberNetwork plus child seat plus child seat", description);
    }
    @Test
    void testVipTaxiWithChildSetExpressGetCost() {
    ...
    @Test
    void testVipTaxiWithChildSetExpressGetDescription() {
        //Given
        TaxiOrder taxiOrder = new BasicTaxiOrder();
        ...
        String description = taxiOrder.getDescription();
        //Then
        assertEquals("Drive a course by TaxiNetwork express service variant VIP plus child seat",description);
    }
}
