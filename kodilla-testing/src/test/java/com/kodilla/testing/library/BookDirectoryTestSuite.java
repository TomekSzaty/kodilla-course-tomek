...
class BookDirectoryTestSuite {
    ...
    private LibraryUser libraryUser = new LibraryUser("Tom","Cruise","12345");
    ...
    void testListBooksInHandsOfZero() {
        ...
        //When
        List<Book>resultListOfUser =  bookLibrary.listBooksInHandsOf(libraryUser);

        //Then
        assertEquals(0, resultListOfUser.size());
    }
    ...
    void testListBooksInHandsOfOne() {
        ...
        //Then
        assertEquals(1, resultListOfUser.size());
    }
    ...
    void testListBooksInHandsOfFive() {
        ...
        //Then
        assertEquals(5, resultListOfUser.size());
    }
}
